...
Project-authored method and reporting code is provided in this repository under Apache License 2.0. The repository includes the authenticated historical HGB implementation, the paired GbV scorer, the supervision-matched logistic fitting and disjoint calibration procedure, fixed selection and analysis kernels, sealed aggregate outputs, and runnable verification tests.
